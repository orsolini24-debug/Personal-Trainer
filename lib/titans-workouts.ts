      ...
      slots: [
        {
          ...
          rpe_target:         [9, 10],
          rest_sec:           [20, 30],
          progression_method: 'volume_first' as unknown as 'linear',
