...
export default function CoachInsights({ mesoId }: CoachInsightsProps) {
  ...
  if (loading) {
    return (
      <div className="bg-surface rounded-[2.5rem] p-8 border border-border flex flex-col items-center justify-center min-h-[200px] animate-pulse">
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      {/* Expected Objectives */}
      <div className="bg-surface rounded-[2.5rem] p-8 border border-border relative overflow-hidden group hover:border-primary/30 transition-all">
      ...
      {/* Next Phase Preview */}
      <div className="bg-surface rounded-[2.5rem] p-8 border border-border relative overflow-hidden group hover:border-accent/30 transition-all">
        <div className="absolute top-0 right-0 p-6 opacity-[0.03] group-hover:-rotate-12 transition-transform duration-700">
        ...
        <div className="relative z-10">
          ...
          <div className="pt-4 border-t border-border-subtle flex items-center justify-between group/link cursor-pointer">
      ...
      <div className="md:col-span-2 bg-surface rounded-[2.5rem] p-8 border border-border relative overflow-hidden group hover:border-positive/30 transition-all">
        <div className="absolute top-0 right-0 p-6 opacity-[0.03] group-hover:scale-110 transition-transform duration-700">
          <TrendingUp className="w-48 h-48 text-positive" />
        </div>
        <div className="relative z-10">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
            <div>
              <h3 className="text-xs font-black uppercase tracking-[0.2em] text-positive mb-2 flex items-center gap-2">
          ...
          {insights.adjustments.length > 0 && (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {insights.adjustments.map((adj, i) => (
                <div key={i} className="bg-base p-4 rounded-2xl border border-border flex items-center gap-3 group/adj hover:border-positive/50 transition-all">
